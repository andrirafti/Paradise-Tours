...
export const getAllSuites = async (location_id,hotel_id) => {
  const resp = await api.get(`/locations/${location_id}/hotels/${hotel_id}/suites`);
  return resp.data;
}
export const getOneSuite = async (location_id,hotel_id,suite_id) => {
  const resp = await api.get(`/locations/${location_id}/hotels/${hotel_id}/suites/${suite_id}`);
  return resp.data;
}
